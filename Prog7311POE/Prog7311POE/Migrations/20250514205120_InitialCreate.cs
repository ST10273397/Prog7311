    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "aiden@agri.com", "Aiden Evard", "EmployeePassword123" });

            migrationBuilder.InsertData(
                table: "Farmers",
                columns: new[] { "Id", "Email", "EmployeeId", "FullName", "Password" },
                values: new object[] { 1, "joe@farm.com", 1, "Joe Herder", "secret" });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Category", "FarmerId", "Name", "productionDate" },
                values: new object[] { 1, "Grain", 1, "Corn", new DateTime(2025, 5, 14, 0, 0, 0, 0, DateTimeKind.Unspecified) });
